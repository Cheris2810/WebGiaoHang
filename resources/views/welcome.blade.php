...
<div class="w3-main w3-content w3-padding" style="max-width:1300px;margin-top:60px;margin-left:9em">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="service" >
    ...
    <div class="w3-quarter">
      <a href="#monphu"><img src="{{asset('public/fontend/img/ghtietkiem/shiptietkiem.png')}}" alt="Cherries" style="width:130%;margin-left:16rem"></a>
    ...
    <h3>Tin tức</h3><br>
      <section class="blog-sec">
        <div class="blog-content" >
            ...
            <!-- <div class="blog-2"  id="blog2" style="border:1px solid;margin-left: 14rem; margin-right: 14rem; border-radius: 100px; background-color: white; margin-top:-36.5rem">
              <img src="{{asset('public/fontend/img/blog/2.png')}}" height="400" width="800" style="border-radius: 100px;">
              <h1 style="color:black">Năm 2023, Viettel Post (VTP – UpCom) được đề cử tại 3 hạng mục Kinh doanh quốc tế</h1>
              <h4 style="color:black">💗 Cụ thể, năm nay, Viettel Post giành giải Vàng hạng mục Website và ứng dụng dành cho thiết bị di động cho App Viettel Post, hai giải Đồng tại hạng mục Công ty của năm ngành Giao thông Vận tải [...] </h4>
            </div>
            <div class="blog-3"  id="blog3" style="border:1px solid;margin-left: 14rem; margin-right: 14rem; border-radius: 100px; background-color: white;  margin-top:-42rem">
              <img src="{{asset('public/fontend/img/blog/3.jpg')}}" height="400" width="800" style="border-radius: 100px;">
              <h1 style="color:black">Qúy IV/2022, đưa tổng doanh thu hợp nhất lên mức tăng trưởng 2 con số</h1>
              <h4 style="color:black">💗 Ngày 30/1, đại diên Tổng Công ty Cổ phần Bưu chính Viettel (Viettel Post) cho biết, sau 7 tháng tập trung vào đầu tư hạ tầng mạng lưới và công nghệ, tối ưu quy trình vận hành, quý IV/2022 [...] </h4>
            </div>
