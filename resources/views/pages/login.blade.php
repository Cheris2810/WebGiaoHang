...
<div class="w3layouts-main">
	...
	?>
		<form action="{{URL::to('/home')}}" method="post">
			{{csrf_field()}}
			<input type="email" class="ggg" name="email_user" placeholder="Điền Email" required="">
			<input type="password" class="ggg" name="password_user" placeholder="Điền mật khẩu" required="">
